  ...
  * `ng add ngx-scrolltop`
    ...
    * The following tag will be added to the app.component.html
      * `<ngx-scrolltop></ngx-scrolltop>`
        * NOTE: If you do not want the scroll top on all pages, then remove the ngx-scrolltop tags from app.component.html and add the tags to specific component pages
